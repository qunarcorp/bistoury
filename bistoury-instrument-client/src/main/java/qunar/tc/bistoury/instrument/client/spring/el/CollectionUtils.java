...
public abstract class CollectionUtils {
    ...
    /**
     * Find the common1 element type of the given Collection, if any.
     *
     * @param collection the Collection to check
     * @return the common1 element type, or {@code null} if no clear
     * common1 type has been found (or the collection was empty)
     */
