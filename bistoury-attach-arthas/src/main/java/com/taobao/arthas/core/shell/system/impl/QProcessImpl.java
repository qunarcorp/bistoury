...
import qunar.tc.bistoury.attach.arthas.server.BistouryBootstrap;
 ...
 */
public class QProcessImpl implements Process {
    ...
    public QProcessImpl(Command commandContext, List<CliToken> args, Handler<CommandProcess> handler,
    ...
    public synchronized void run(boolean fg) {
        ...
        BistouryBootstrap.getInstance().execute(task);
    }
    ...
    private class CommandProcessImpl implements CommandProcess {
        ...
        @Override
        public String cacheLocation() {
            return QProcessImpl.this.cacheLocation();
        }
