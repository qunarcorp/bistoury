...
sleep 10
# mysql 镜像
docker run --name mysql -p 3307:3306 -e MYSQL_ROOT_PASSWORD=root -d -i --net bistoury --ip 172.19.0.7  bistoury-db:v2.0.5
sleep 30
# zk 镜像
docker run -d -p 2181:2181 -it --net bistoury --ip 172.19.0.2 registry.cn-hangzhou.aliyuncs.com/bistoury/zk:v0.1
sleep 10
# proxy 镜像
docker run -d -p 9880:9880 -p 9881:9881 -p 9090:9090 -i --net bistoury --ip 172.19.0.3 bistoury-proxy:v2.0.5 --real-ip $1 --zk-address 172.19.0.2:2181 --parse-agent-id true --proxy-jdbc-url jdbc:mysql://172.19.0.7:3306/bistoury
# ui 镜像
