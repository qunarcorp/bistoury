...
docker run -d -p 9880:9880 -p 9881:9881 -p 9090:9090 -i --net bistoury --ip 172.19.0.3 registry.cn-hangzhou.aliyuncs.com/bistoury/bistoury-proxy --real-ip $1 --zk-address 172.19.0.2:2181 --parse-agent-id true --proxy-jdbc-url jdbc:mysql://172.19.0.7:3306/bistoury
#ui 镜像
