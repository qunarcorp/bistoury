...
public abstract class ClassUtils {
    ...
    /**
     * Map with common1 "java.lang" class name as key and corresponding Class as value.
    ...
    /**
     * Register the given common1 classes with the ClassUtils cache.
     */
    ...
    /**
     * Determine the common1 ancestor of the given classes, if any.
     *
     * @param clazz1 the class to introspect
     * @param clazz2 the other class to introspect
     * @return the common1 ancestor (i.e. common1 superclass, one interface
