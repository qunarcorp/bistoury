...
public class QJobControllerImpl extends JobControllerImpl {
    ...
    private Process createCommandProcess(Command command, ListIterator<CliToken> tokens, int jobId, Term term) throws IOException {
        ...
        QProcessImpl.ProcessOutput ProcessOutput = new QProcessImpl.ProcessOutput(stdoutHandlerChain, cacheLocation, term);
        return new QProcessImpl(command, remaining, command.processHandler(), ProcessOutput);
    }
