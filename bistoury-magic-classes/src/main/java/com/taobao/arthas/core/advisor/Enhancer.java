...
/**
 * @edit leix.xie
 * @describe 由于agent需要多线程使用cache，所以将classBytesCache修改为public，同时，在读取和写时添加锁
 */
public class Enhancer implements ClassFileTransformer {
    ...
    // 类-字节码缓存
    public final static Map<Class<?>/*Class*/, byte[]/*bytes of Class*/> classBytesCache
        ...
        try {
            ...
            try {
                ...
                cr.accept(new AdviceWeaver(adviceId, isTracing, skipJDKTrace, cr.getClassName(), methodNameMatcher, affect,
                        cw), EXPAND_FRAMES);
                enhanceClassByteArray = cw.toByteArray();
