...
BISTOURY_PACKAGE_DIR="$SCRIPT_DIR/bistoury-$BISTOURY_PROJECT_VERSION"
...
cp $SCRIPT_DIR/demo-start.sh $BISTOURY_PACKAGE_DIR
cp -R $SCRIPT_DIR/h2 $BISTOURY_PACKAGE_DIR
tar -czvf $BISTOURY_PACKAGE_DIR.tar.gz $BISTOURY_PACKAGE_DIR