        ...
        while (!stack.isEmpty()) {
            ...
            for (DirectNode nd : node.succs) {
                ...
                if (isSuccessor) {
                    ...
                    Map<String, PrimitiveExprsList> mapSucc = Map827.computeIfAbsent(mapData, nd, new Function<DirectNode, Map<String, PrimitiveExprsList>>() {
                        @Override
                        public Map<String, PrimitiveExprsList> apply(DirectNode input) {
                            return new HashMap<>();
                        }
                    });
