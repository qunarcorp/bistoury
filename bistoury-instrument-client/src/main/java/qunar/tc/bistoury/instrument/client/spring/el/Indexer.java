...
class Indexer extends SpelNodeImpl {
    ...
    private class ArrayIndexingValueRef implements ValueRef {
        ...
        public void setValue(Object newValue) {
            //setArrayElement(this.typeConverter, this.array, this.index, newValue,this.typeDescriptor.getElementTypeDescriptor().getType());
        }
