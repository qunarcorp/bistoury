...
abstract class CollectionFactory {
	 ...
	 * creates a {@link LinkedHashSet}, since Spring 2.5
	 ...
	 * This implementation always creates a {@link CopyOnWriteArraySet},
	 ...
	 * creates a {@link LinkedHashMap}, since Spring 2.5
	 * requires JDK 1.4 anyway.
	 ...
	 * creates a {@link IdentityHashMap}, since Spring 2.5
	 * requires JDK 1.4 anyway.
	 * @param initialCapacity the initial capacity of the Map
	 * @return the new Map instance
	 * @deprecated as of Spring 2.5, for usage on JDK 1.4 or higher
	 ...
	 * creates a {@link ConcurrentHashMap}, since Spring 3.0
